...
$listMealTemplate = sprintf('<li id="meal-template" class="meal-listing" data-dishes="88,91">%s<h2>Unnamed Meal</h2><p><strong></strong><em>No dishes have been added to this meal</em></p></li>', $listDecoSide);
