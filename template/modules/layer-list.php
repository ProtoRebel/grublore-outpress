...
$listMealTemplate = sprintf('<li id="meal-template" class="meal-listing" data-dishes="124">%s<h2>Unnamed Meal</h2><p><strong></strong><em>No dishes have been added to this meal</em></p></li>', $listDecoSide);
//$listSampleDataOne = sprintf('<li id="93jdks" class="meal-listing" data-dishes="124">%s<h2>Sunday Dinner</h2><p><strong>Butter Chicken + Biryani Rice + Garlic Naan</strong><em>Buy naan and spread garlic on it</em></p></li>', $listDecoSide);
